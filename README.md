...
1. Download the JAR file from the below link: 
  https://github.com/HimalayGoswami/TwitterDemoProject/raw/Make_It_Rest_ful/target/TwitterDemoProject-1.0-SNAPSHOT.jar
...
3. Create a ".yml" file, copy the content from below given link:
   https://github.com/HimalayGoswami/TwitterDemoProject/blob/Make_It_Rest_ful/src/main/resources/TwitterDemoConf.yml
